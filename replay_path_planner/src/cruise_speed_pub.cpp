...
int main(int argc, char **argv) {
  ...
  ros::Subscriber current_speed_sub =
      n.subscribe("/casper_auto/current_speed", 10, currentSpeedCallback);
  ros::Publisher cruise_speed_pub =
      n.advertise<std_msgs::Float32>("/casper_auto/cruise_speed", 10);
  ...
  vector<double> speed_cmds = {5}; // {1, 3, 5, 3, 1};
